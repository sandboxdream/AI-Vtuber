...
![image](https://github.com/Ikaros-521/AI-Vtuber/assets/40910637/2e0f41ed-29ab-4d51-af47-b8bb3fc7ee2d)
...
vits-simple-api配置，修改config.py，参考配置如下，路径为追加的相对模型路径和配置文件路径：
```
