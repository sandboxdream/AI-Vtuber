...
def wssServerStart(roomId):
    ...
    webSocketUrl = 'wss://webcast3-ws-web-lq.douyin.com/webcast/im/push/v2/?app_name=douyin_web&\
        ...
        internal_ext=internal_src:dim|wss_push_room_id:'+liveRoomId+'|wss_push_did:7188358506633528844|\
            ...
            user_unique_id=7188358506633528844&device_platform=web&cookie_enabled=true&screen_width=1440&screen_height=900&\
            browser_language=zh&browser_platform=MacIntel&browser_name=Mozilla&\
            browser_version=5.0%20(Macintosh;%20Intel%20Mac%20OS%20X%2010_15_7)%20AppleWebKit/537.36%20(KHTML,%20like%20Gecko)%20\
            Chrome/113.0.0.0%20Safari/537.36&browser_online=true&tz_name=Asia/Shanghai&identity=audience&room_id='+liveRoomId+'&\
...
try: 
    ...
    ws = websocket.WebSocketApp(ws_url, on_message=onMessage, on_error=onError, on_close=onClose,
        on_open=onOpen)
